...
class Puzzle(object):
    ...
    sound="D:\OOP\Project\SubMusic.ogg"
...
class Hard(Puzzle):
    ...
    first=p.image.load(r"D:\OOP\Project\farm1.png").convert()
    second=p.image.load(r"D:\OOP\Project\farm2.png").convert()
    third=p.image.load(r"D:\OOP\Project\farm3.png").convert()
    fourth=p.image.load(r"D:\OOP\Project\farm4.png").convert()
