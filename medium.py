...
class Medium(Puzzle):
    ...
    first=p.image.load(r"D:\OOP\Project\X1.png").convert()
    second=p.image.load(r"D:\OOP\Project\X2.png").convert()
    third=p.image.load(r"D:\OOP\Project\X3.png").convert()
    fourth=p.image.load(r"D:\OOP\Project\X4.png").convert()
