...
class Puzzle(object):
    ...
    sound="D:\Project\SubMusic.ogg"

    def Win(self):
        p.init()
        Wint=p.display.set_mode((400,400))
        p.display.set_caption("Game Over")
        Wimg=p.image.load(r"D:\Project\game-result-win.png").convert()
    ...
    def Lose(self):
        ...
        p.display.set_caption("Game Over")
        Limg=p.image.load(r"D:\Project\you-lose1.png").convert()
    ...
    def Sound(self):
        p.mixer.init()
        p.mixer.music.load("D:\Project\SubMusic.ogg")
        p.mixer.music.play()
...
class Easy(Puzzle):
    ...
    first=p.image.load(r"D:\Project\looneytunes1.png").convert()
    second=p.image.load(r"D:\Project\looneytunes2.png").convert()
    third=p.image.load(r"D:\Project\looneytunes3.png").convert()
    fourth=p.image.load(r"D:\Project\looneytunes4.png").convert()
