...
class Main(object):
    p.init()
    bg_music="D:\OOP\Project\MainMusic.ogg"
    bg_img="D:\OOP\Project\puzzle_main.png"
    ...
    def __init__(self,master):
        ...
        self.img = PhotoImage(file=r"D:\OOP\Project\puzzle_main.png")
    ...
    def music(self):
        p.mixer.init()
        p.mixer.music.load("D:\OOP\Project\MainMusic.ogg")
        p.mixer.music.play()
    ...
    def Instructions(self):
        ...
        Inimg=p.image.load(r"D:\OOP\Project\inst.png")
